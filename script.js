...
function enterSpace(){
   ...
   /* Intentar iniciar música, pero sin bloquear la entrada */
   if(music){
...
addEventListener('mousemove',e=>{
    ...
    `translate3d(${x*13 + MAKIMA_X}px,${y*-9 + MAKIMA_Y}px,0)`;

    stage.style.transform=
    `translate3d(${x*-3}px,${y*-2}px,0)`;
});
...
/* ==========================================================
   GALLERY: add as many entries as you want.
   Just copy an object and change image/title/description.
   ========================================================== */
const GALLERY_ITEMS=[
...
function updateGallery(){
 ...
 cards.forEach((card,i)=>{
  ...
  const x=o*185,z=-a*115,scale=a===0?1:Math.max(.58,1-a*.12),rot=s*Math.min(34,a*13),opacity=a>3?0:Math.max(.22,1-a*.23),blur=a===0?0:Math.min(3,a*.8),y=a===0?0:Math.min(45,a*12);
...
const miniEqualizer =
document.getElementById('miniEqualizer');
...
const miniSongName =
document.getElementById('miniSongName');

const musicPrevButton =
...
function updateMusic(){
    ...
    if(miniEqualizer){
        ...
        miniEqualizer.classList.toggle(
            'is-playing',
            musicPlaying
        );
    ...
    if(bigVisualizer){
        ...
        bigVisualizer.classList.toggle(
            'active',
            musicPlaying
        );
...
function animateBigVisualizer(){
    ...
    if(bigVisualizer){
        ...
        const bars =
        bigVisualizer.querySelectorAll('span');
...
function loadMusic(index, autoplay = false){
    ...
    musicIndex =
    (index + MUSIC_ITEMS.length) %
    MUSIC_ITEMS.length;


    const song =
    MUSIC_ITEMS[musicIndex];
    ...
    /*
     * Esperar a que el navegador haya cargado
     * la metadata antes de intentar reproducir.
     */
...
if(musicPrevButton){
    ...
    musicPrevButton.addEventListener(
        'click',
        () => {
...
if(musicNextButton){
    ...
    musicNextButton.addEventListener(
        'click',
        () => {
...
const mediaItems = [

   {
      ...
      quote: 'Release: 2022',
      images:[
         'assets/media/images/media01-01.jpg',
         'assets/media/images/media01-02.jpg',
         'assets/media/images/media01-03.jpg'
         ]
   },

{
   ...
   quote: 'Release: 2013 ',
   images:[
      'assets/media/images/media02-01.jpg',
      'assets/media/images/media02-02.jpg',
      'assets/media/images/media02-03.jpg'
   ]
},

{
   ...
   quote: 'Release: 2020',
   images:[
      'assets/media/images/media03-01.jpg',
      'assets/media/images/media03-02.jpg',
      'assets/media/images/media03-03.jpg'
   ]
},

{
   ...
   quote: 'Release: 2026.',
   images:[
      'assets/media/images/media04-01.jpg',
      'assets/media/images/media04-02.jpg',
      'assets/media/images/media04-03.jpg'
   ]
},

{
   ...
   quote: 'Release: 2022 ',
   images:[
      'assets/media/images/media05-01.jpg',
      'assets/media/images/media05-02.jpg',
      'assets/media/images/media05-03.jpg'
   ]
},

{
   ...
   quote: 'Release: 2026 ',
   images:[
      'assets/media/images/media06-01.jpg',
      'assets/media/images/media06-02.jpg',
      'assets/media/images/media06-03.jpg'
   ]
},

{
   ...
   quote: 'Release: 2010',
   images:[
      'assets/media/images/media07-01.jpg',
      'assets/media/images/media07-02.jpg',
      'assets/media/images/media07-03.jpg'
   ]
}
...
const mediaImage1 =
document.getElementById('mediaImage1');

const mediaImage2 =
document.getElementById('mediaImage2');

const mediaImage3 =
document.getElementById('mediaImage3');
...
function updateMedia(index, direction = 1){
   ...
   const frame =
   document.querySelector('.media-video-frame');
   ...
   if(!frame || !mediaVideo || !mediaVideoSource){
      ...
      if(mediaCurrent){
         mediaCurrent.textContent =
         String(mediaIndex + 1).padStart(2,'0');
      }

      if(mediaType){
         mediaType.textContent = item.type;
      }
      ...
      if(mediaQuote){
         mediaQuote.textContent = item.quote;
      }
   ...
   if(direction > 0){
      frame.classList.add('slide-out-up');
   }else{
      frame.classList.add('slide-out-down');
   }
   ...
   setTimeout(() => {
      ...
      if(playPromise !== undefined){
         ...
         playPromise.catch(() => {
            ...
            console.warn(
               'El navegador bloqueó el autoplay del video.'
            );
      ...
      if(direction > 0){
         frame.classList.add('slide-in-from-bottom');
      }else{
         frame.classList.add('slide-in-from-top');
      }
...
if(mediaPrev){
   mediaPrev.addEventListener('click', previousMedia);
}
...
document.addEventListener('keydown', (event) => {
   ...
   const futurePanel =
   document.getElementById('panel-future');

   if(!futurePanel) return;

   if(!futurePanel.classList.contains('is-open')){
      return;
   }
...
/* =========================================================
 * HOLOGRAPHIC PARALLAX SYSTEM
 * Pochita / Gallery / Media
 * ========================================================= */
...
const pochitaParallax =
document.querySelector('.music-pochita');
...
if(galleryTrack){
   ...
   galleryTrack.addEventListener(
      ...
      event => {
         ...
         /*
          * IMPORTANTE:
          * Tu JS crea las tarjetas como
          * .gallery-card, no .gallery-item
          */
          ...
          * para conservar el efecto elegante
          */
